...
namespace NFTT
{
    ...
    public partial class AdventureWorksEntities : DbContext
    {
        ...
        public virtual ObjectResult<uspGetAllEmployee_Result> uspGetAllEmployee()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<uspGetAllEmployee_Result>("uspGetAllEmployee");
        }
